...
public class VerifyPhone extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        heading = findViewById(R.id.numberinfo);
        codesent = findViewById(R.id.code);
        resend = findViewById(R.id.resend);
        resend.setEnabled(false);
        mAuth = FirebaseAuth.getInstance();
        verify = findViewById(R.id.verify);
        String number = getIntent().getStringExtra(constant.USER_PHONENUMBER);
        heading.setText("Please input the code sent to "+ number + " in the input box below.");
